	...
	return{
		show:function(c,u,w,h,a,t){
			if(!f){
				...
				b.onclick=TINY.box.hide; window.onresize=TINY.box.resize; f=1
			}
			if(!a&&!u){
				p.style.width=w?w+'px':'auto'; p.style.height=h?h+'px':'auto';
				p.style.backgroundImage='none'; b.innerHTML=c+"<br><a id='zxxBox''+ onclick = '' +' style='display:inline-block;width:100%; text-align:center;border-top:solid 1px #eee;color:#37a8ff' class='ml20'>好</a>"
			}else{
